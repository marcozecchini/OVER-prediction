...
accuracy = mean_accuracy_with_confidence_interval(predict_y_array, interval_size=0.7, Y_test=Y_test)
...
plt.errorbar(test_date, predict_y_array, yerr=st.median(predict_y_array)[0] * 0.7, fmt='--o')
plt.xlabel('dates')
plt.ylabel('Kwh')
